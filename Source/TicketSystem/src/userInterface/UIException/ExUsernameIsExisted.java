...
public class ExUsernameIsExisted extends Exception {
	public ExUsernameIsExisted() {
		super("The username is existed.");
		JFrame jf = new JFrame("ExUsernameIsExisted");
		...
		JLabel text = new JLabel("Username is existed.");
	...
	public ExUsernameIsExisted(String msg) {
		super(msg);
	}
}

...
public class ExPasswordIsWrong extends Exception {

	public ExPasswordIsWrong() {
		super("The password is wrong.");
		JFrame jf = new JFrame("ExPasswordIsWrong");
		...
		JLabel text = new JLabel("Password is wrong.");
	...
	public ExPasswordIsWrong(String msg) {
		super(msg);
	}
}

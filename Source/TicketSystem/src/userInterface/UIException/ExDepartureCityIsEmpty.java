...
public class ExDepartureCityIsEmpty extends Exception {

	public ExDepartureCityIsEmpty() {
		super("The departure city is empty.");
		JFrame jf = new JFrame("ExDepartureCityIsEmpty");
		...
		JLabel text = new JLabel("Departure city cannot be empty.");
	...
	public ExDepartureCityIsEmpty(String msg) {
		super(msg);
	}
}

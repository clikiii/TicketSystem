...
public class ExDestinationCityIsNotFound extends Exception {

	public ExDestinationCityIsNotFound() {
		super("The destination city is not found.");
		JFrame jf = new JFrame("ExDestinationCityIsNotFound");
		...
		JLabel text = new JLabel("Destination city is not found.");
	...
	public ExDestinationCityIsNotFound(String msg) {
		super(msg);
	}
}
